...
<template>
  <div class="pagination__container">
    <on-first-page
      ...
      @click="changePage(1)"
    />
    <decrement class="pagination__image"
      :class="{
        'image__disabled': paintingsStore.page === 1,
        'pagination__image--dark': paintingsStore.theme === 'dark'
      }"
    ...
    <div
      ...
      v-for="page in paintingsStore.pages" :key="page"
      @click="changePage(page)"
    >
      {{page}}
    </div>
    <increment class="pagination__image"
      :class="{
      ...
      @click="changePage(paintingsStore.page += 1)"
    />
    <on-last-page class="pagination__image pagination__last"
      :class="{
        'image__disabled': paintingsStore.page === paintingsStore.pages,
        'pagination__image--dark': paintingsStore.theme === 'dark'
      }"
